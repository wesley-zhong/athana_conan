...
void GameServerNetWorkHandler::startLogicThread(int ioThread, int logicThread, int dbThread)
{
    GameActor::initActors(IO, ioThread);
    GameActor::initActors(LOGIC, logicThread);
    GameActor::initActors(DB, dbThread);
}
