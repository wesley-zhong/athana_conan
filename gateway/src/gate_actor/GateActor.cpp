...
std::vector<std::vector<core::actor::Actor*>> GateActor::actors(ACTOR_TYPE_COUNT);
...
void GateActor::initActors(ActorType actorType, int count)
{
...
void GateActor::execute(ActorType actorType, int hashCode, std::function<void()> func)
{
